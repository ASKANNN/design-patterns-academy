...
> A premium source-available educational platform for learning GoF Design Patterns.

---

## Overview

Design Patterns Academy is a modern source-available educational platform dedicated exclusively to the Gang of Four (GoF)
Design Patterns.
...
Non-commercial source license © Design Patterns Academy.

Commercial use is not permitted without prior written permission. See [LICENSE](./LICENSE).
