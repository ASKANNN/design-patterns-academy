      ...
      <div class="footer__inner container">
        ...
        <div class="footer__brand">
          ...
          <p class="footer__tagline" data-i18n="footer.tagline">
            A premium source-available educational platform for learning the 23 Gang of Four Design Patterns.
          </p>
        </div>
        ...
        <div class="footer__bottom">
          <p class="footer__copyright">
            © ${year} <span data-i18n="footer.copyright">Design Patterns Academy. Non-commercial source license.</span>
          </p>
          <a
