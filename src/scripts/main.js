...
import '../styles/components/accessibility-widget.css';
import '../styles/components/scroll-top-button.css';
...
import { initAnimations, revealApp, themeTransition } from './animations.js';
import { getLang, setLanguage }    from '../config/i18n.js';
import { ROUTES }                  from '../config/routes.js';
import { restoreTheme, applyTheme, nextTheme } from '../config/theme.js';
import { restoreA11y }             from '../config/accessibility.js';
import { AccessibilityWidget, initAccessibilityWidget } from '../components/ui/AccessibilityWidget.js';
import { ScrollTopButton, initScrollTopButton } from '../components/ui/ScrollTopButton.js';

restoreTheme();
restoreA11y();

document.getElementById('app').innerHTML = AppLayout();
document.body.insertAdjacentHTML('beforeend', AccessibilityWidget());
